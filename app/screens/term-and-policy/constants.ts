export const LOREM = [
  {
    title: 'Lorem ipsum',
    content: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquet ut fermentum, aliquam scelerisque sodales morbi. Nisi, vel dis egestas neque, fringilla mauris senectus volutpat eu. Fermentum dolor mi quam sem elementum, eu. Egestas in ut integer tortor aliquam.'
  },{
    title: 'Lorem ipsum',
    content: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquet ut fermentum, aliquam scelerisque sodales morbi. Nisi, vel dis egestas neque, fringilla mauris senectus volutpat eu. Fermentum dolor mi quam sem elementum, eu. Egestas in ut integer tortor aliquam.'
  },{
...
export const TERMS_OF_USE_CONTETNT = [
  ...
  'Thông tin về các khoản vay, trái phiếu, đầu tư bán/cho thuê bất động sản cùng với hình ảnh, nội dung, tin tức, phần mềm được hỗ trợ và đăng từ FINA.',
...
export const WEBSITE_CONTENT = [
  'Không sử dụng bất kỳ thiết bị, phần mềm, quy trình, phương tiện để can thiệp hay cố gắng can thiệp vào hoạt động đúng đắn trên FINA. Người sử dụng phải chịu trách nhiệm bồi thường cho FINA mọi thiệt hại phát sinh từ những hành vi vi phạm quy định tại mục này của Người sử dụng.',
  'Bạn có thể tải các tài liệu tham khảo trên website của FINA về làm thông tin tham khảo, nhưng tuyết đối không điều chỉnh các thông tin đó thành thông tin sai, hoặc vi phạm pháp luật và sau đó truyền tải đến những người dùng khác. Mọi thiệt hại đối với FINA và bất kỳ bên thứ ba nào phát sinh từ việc điều chỉnh thông tin của Người sử dụng sẽ do Người sử dụng chịu trách nhiệm bồi thường.',
  'FINA sẽ không sắp đặt, uỷ quyền hay cho phép bất cứ một tổ chức nào đối với các tài liệu của fina.com.vn  trừ khi có văn bản đồng ý chính thức.',
  'FINA sẽ chịu trách nhiệm cho sự an toàn, hợp pháp, tính toàn vẹn của các dữ liệu, thông tin được đăng trên website.',
]

export const USED_SERVICE = [
  ...
  'fina.com.vn  không ngừng thay đổi và cải tiến Dịch vụ của mình. Chúng tôi có thể thêm hoặc xóa các chức năng hoặc tính năng và chúng tôi cũng có thể tạm ngừng hoặc ngừng hoàn toàn một Dịch vụ. Chúng tôi sẽ gửi thông báo đến cho bạn để bạn nắm bắt các thông tin này một cách nhanh nhất và chính xác nhất.'
]

export const SEND_SUPPORT_INFORMATION = [
  'Bạn chỉ gửi yêu cầu hỗ trợ về các thông tin hỗ trợ trên website của FINA qua các kênh như điện thoại, email, chat. Nếu bạn nhận được bất kỳ thông tin hỗ trợ nào nhưng không phải từ các kênh này của chúng tôi, thì vui lòng bỏ qua thông tin đó. Chúng tôi hoàn toàn không chịu trách nhiệm cho các thông tin giả mạo đó.',
  'Không gửi hàng loạt các thông tin rác, yêu cầu hỗ trợ giả mạo hoặc mang tính chất đùa giỡn đến FINA.',
  'Chỉ nhập các thông tin được yêu cầu trong phần liên hệ. Không đính kèm hoặc sử dụng các từ ngữ mang tính chất xấu như các từ ngữ phản động hoặc sử dụng các từ ngữ khiếm nhã…',
  'Thành thật trong việc cung cấp các thông tin về các sản phẩm vay Bất Động Sản (“BĐS”), các thông tin được cung cấp sau khi chuyên viên chúng tôi xác thực lại, sẽ bị bỏ đi nếu chua đúng với thực tế.'
]
export const SHARE_SOCIAL_NETWORK = [
  'Các thông tin, bài viết, chia sẻ hữu ích trên website của chúng tôi bạn có thể chia sẻ trên các trang mạng xã hội cá nhân của bạn như: Facebook, Twitter, Youtube, Email. Khi bạn muốn chia sẻ các thông tin của chúng tôi trên các trang cá nhân này của bạn, đồng nghĩa với việc bạn đã đồng ý thực hiện các thao tác chia sẻ thông tin các tài khoản này với FINA, như vậy chúng tôi mới có thể hỗ trợ bạn việc chia sẻ này.'
]
