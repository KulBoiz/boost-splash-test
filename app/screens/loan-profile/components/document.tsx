    ...
    <View style={styles.container}>
      <View style={styles.content}>
        ...
        <View style={styles.contentItem}>
          <ItemView style={styles.item} title={"loan.infoLoan.info.loanDemand"} content={'Mua nhà có sổ'} />
          <ItemView style={styles.item} title={"loan.infoLoan.info.collateral"} content={'GTK-9WI'} />
          <ItemView style={styles.item} title={"loan.infoLoan.info.money"} content={'2,000,000'} />
          <ItemView style={styles.item} title={"loan.infoLoan.info.time"} content={'20 Năm'} />
        </View>
      </View>
